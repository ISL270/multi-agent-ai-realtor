...
class TestRenderPropertyCarouselCustom:
    ...
    def test_successful_carousel_rendering_single_property(self, mock_uuid, mock_push_ui):
        ...
        # Create test filters
        test_filters = PropertySearchFilters(city="Cairo", bedrooms=4, max_price=800000.0)
        ...
        result = render_property_carousel.func(state=test_state, tool_call_id="test_call_123")
    ...
    def test_successful_carousel_rendering_multiple_properties(self, mock_uuid, mock_push_ui):
        ...
        # Create test filters
        test_filters = PropertySearchFilters(city="Cairo", bedrooms=3, property_type="apartment")
        ...
        # Call the tool function directly to bypass InjectedState validation
        result = render_property_carousel.func(state=test_state, tool_call_id="test_call_456")
    ...
    def test_no_properties_available(self):
        ...
        # Call the tool function directly to bypass InjectedState validation
        result = render_property_carousel.func(state=test_state, tool_call_id="test_empty_call")
    ...
    def test_rendering_without_filters(self, mock_uuid, mock_push_ui):
        ...
        # Call the tool function directly to bypass InjectedState validation
        result = render_property_carousel.func(state=test_state, tool_call_id="test_no_filters_call")
    ...
    def test_price_range_formatting(self, mock_uuid, mock_push_ui):
        ...
        test_cases = [
            ...
            # Only min price
            {"filters": PropertySearchFilters(min_price=300000.0), "expected": "price range: min $300,000"},
            # Only max price
            {"filters": PropertySearchFilters(max_price=800000.0), "expected": "price range: max $800,000"},
        ]
        ...
        for test_case in test_cases:
            ...
            result = render_property_carousel.func(state=test_state, tool_call_id="test_price_call")
    ...
    def test_exception_handling(self, mock_push_ui):
        ...
        # Call the tool function directly to bypass InjectedState validation
        result = render_property_carousel.func(state=test_state, tool_call_id="test_error_call")
    ...
    def test_property_model_dump_conversion(self, mock_uuid, mock_push_ui):
        ...
        # Call the tool function directly to bypass InjectedState validation
        render_property_carousel.func(state=test_state, tool_call_id="test_conversion_call")
