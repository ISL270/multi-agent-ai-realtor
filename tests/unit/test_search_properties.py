...
class TestSearchPropertiesUnit(ToolsUnitTests):
    ...
    def tool_invoke_params_example(self):
        ...
        sample_filters = PropertySearchFilters(city="Cairo", bedrooms=3, max_price=500000.0, amenities=["pool", "gym"])

        return {"filters": sample_filters, "tool_call_id": "test_call_id_123"}
...
class TestSearchPropertiesCustom:
    ...
    def test_successful_search_with_results(self, mock_supabase):
        ...
        # Create test filters
        filters = PropertySearchFilters(city="Cairo", bedrooms=3, max_price=500000.0, amenities=["gym"])

        # Call the tool
        result = search_properties.invoke({"filters": filters, "tool_call_id": "test_call_123"})
    ...
    def test_parameter_mapping(self, mock_supabase, filters_data, expected_params):
        ...
        # Call the tool
        search_properties.invoke({"filters": filters, "tool_call_id": "test_call_123"})
